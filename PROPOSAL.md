...
Assumptions are labelled. 1,254 words of prose plus two tables.*
...
staleness (median 121 days), batch size, score distribution — needing no labels, these are
the only signals that catch anything this week. *Four-weekly:* rep dispositions by tier.
*Quarterly:* conversion, queued versus control.
